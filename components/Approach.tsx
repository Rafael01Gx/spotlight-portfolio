        ...
        <section className="w-full py-20">
            ...
            <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
                <Card
                    ...
                    des="Colaboraremos para mapear os objetivos, o público-alvo e as principais funcionalidades do seu site. Discutiremos aspectos como a estrutura do site, a navegação e os requisitos de conteúdo."
                >
                    <CanvasRevealEffect
                        animationSpeed={5.1}
                ...
                <Card
                    title="Desenvolvimento & Acompanhamento Contínuo"
                    icon={<AceternityIcon order="Fase 2"/>}
                    des="Após alinharmos todos os detalhes, inicio o desenvolvimento com foco total.
Desde os primeiros rascunhos até a entrega final, você acompanha cada etapa com atualizações constantes, garantindo total transparência e colaboração."
                >
                    <CanvasRevealEffect
                        animationSpeed={3}
